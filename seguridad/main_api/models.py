...
class HojaUrgencias(models.Model):
    ...
    CUCEI = models.BooleanField(default=False)
    Prepa12 = models.BooleanField(default=False)
    VOCA = models.BooleanField(default=False)
    ...
    TrasladoCUCEI = models.BooleanField(default=False)
    IMSS = models.BooleanField(default=False)
    ISSSTE = models.BooleanField(default=False)
    SMM = models.BooleanField(default=False)
    CRM = models.BooleanField(default=False)
    PRIVADO = models.BooleanField(default=False)
    SeNiega = models.BooleanField(default=False)
    NoAmerita = models.BooleanField(default=False)
